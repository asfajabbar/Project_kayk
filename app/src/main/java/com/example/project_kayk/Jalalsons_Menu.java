...
public class Jalalsons_Menu extends AppCompatActivity implements IEatLoadListener, ICartLoadListener {
    ...
    private void loadCakeFromFirebase() {
        ...
        FirebaseDatabase.getInstance().getReference("Jalal Sons")
