...
public class CakeMystery_Menu extends AppCompatActivity implements IEatLoadListener, ICartLoadListener {
    ...
    private void loadCakeFromFirebase() {
        ...
        FirebaseDatabase.getInstance().getReference("Cake Mystery")
