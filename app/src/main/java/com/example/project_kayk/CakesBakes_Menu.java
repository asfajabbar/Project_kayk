...
public class CakesBakes_Menu extends AppCompatActivity implements IEatLoadListener, ICartLoadListener {
    ...
    private void loadCakeFromFirebase() {
        ...
        FirebaseDatabase.getInstance().getReference("Cakes n Bakes")
